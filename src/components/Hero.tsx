...
export default function Hero(){
    return(
        <section className="min-h-190 max-md:min-h-screen max-md:h-auto bg-[#17191A] bg-[url('/images/bg.svg')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center max-md:justify-start px-18 max-md:px-4 max-md:pt-4 max-md:pb-8">            <div className = "flex flex-row max-md:flex-col items-center justify-center max-md:text-center max-md:gap-8">
