...
export default function Hero(){
    return(
        <section className = "h-190 max-md:h-auto max-md:min-h-screen bg-[#17191A] bg-[url('/images/bg.svg')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center px-18 max-md:px-4 max-md:py-2 max-md:mb-5">
