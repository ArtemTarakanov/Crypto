        ...
        <section className = "bg-[#1E1F25] bg-[url('/images/ellipse-2.svg')] max-h-220 py-30 px-40 flex items-center justify-center max-md:py-12 max-md:px-4">
            <div className = "flex flex-col gap-15 items-center max-md:gap-7.5">
                <div className = "flex flex-row items-center gap-25 max-md:flex-col max-md:gap-4">
                    ...
                    <p className = "font-source-pro font-normal text-lg leading-7 text-[#ADB3BF] max-w-260 max-md:text-lg max-md:max-w-90 max-md:text-center">Lorem Ipsum has been the industry's standard dummy text since the 1500s, when an unknown printer took a galley of type and scrambled type specimen book.</p>
                </div>
